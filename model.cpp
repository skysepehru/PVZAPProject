...
//    levels.push_back(new Level(3,levelData,false));
    moveSpeed = View::instance->pixelPerSecondsToPixelPerFrame(90);
    levelData  = {new LevelData{2,false,4,moveSpeed,2},
                  new LevelData{4,false,4,moveSpeed,2},
                  new LevelData{6,false,4,moveSpeed,2},
                  new LevelData{8,false,4,moveSpeed,2},
                  new LevelData{10,false,4,moveSpeed,2},
                  };
    ...
    moveSpeed = View::instance->pixelPerSecondsToPixelPerFrame(90);
    levelData  = {new LevelData{1,false,4,moveSpeed,2},
                  new LevelData{2,false,4,moveSpeed,3},
                  new LevelData{4,false,4,moveSpeed,2},
                  new LevelData{6,false,4,moveSpeed,3},
                  new LevelData{8,false,4,moveSpeed,2},
                  new LevelData{9,false,4,moveSpeed,2},
                  new LevelData{11,false,4,moveSpeed,3},
                  new LevelData{14,false,4,moveSpeed,3}
                  };
    ...
    levelData  = {new LevelData{1,false,4,moveSpeed,2},
                  new LevelData{2,false,4,moveSpeed,3},
                  new LevelData{3,false,4,moveSpeed,2},
                  new LevelData{6,false,4,moveSpeed,3},
                  new LevelData{8,false,4,moveSpeed,2},
                  new LevelData{9,false,4,moveSpeed,3},
                  new LevelData{13,false,4,moveSpeed,2},
                  new LevelData{14,false,4,moveSpeed,3},
                  new LevelData{17,false,4,moveSpeed,2},
                  new LevelData{20,false,4,moveSpeed,3}
                  };
